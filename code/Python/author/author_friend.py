...
def read_author():
    ...
    # file2="../data/tang1.xlsx"
    # file2="../data/tang2.xlsx"
    # file2 = "../data/song2.xlsx"
    # file2 = "../data/yuan2.xlsx"
    # file2 = "../data/ming2.xlsx"
    file2 = "../data/qing2.xlsx"
    ...
    for i in range(len(author_name)):
        ...
        for j in range(len(author)):
            ...
            if content.find(author[j]) != -1 and dict_des[author[j]] == "清代":
    ...
    # xl.save("../data2/tang/friend2.xlsx")
    # xl.save("../data2/song/friend2.xlsx")
    # xl.save("../data2/yuan/friend2.xlsx")
    # xl.save("../data2/ming/friend2.xlsx")
    xl.save("../data2/qing/friend2.xlsx")
