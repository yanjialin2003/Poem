...
CREATE TABLE `bms_post`  (
  ...
  `poem_link` int default -1 COMMENT '诗词链接',
...
INSERT INTO `ums_user` VALUES ('1349618748226658305', 'zhangsan', 'zhangsan', '$2a$10$7K3yYv8sMV5Xsc2facXTcuyDo8JQ4FJHvjZ7qtWYcJdei3Q6Fvqdm', 'https://s3.ax1x.com/2020/12/01/DfHNo4.jpg', '23456@qq.com', NULL, 0, '', '自由职业者', b'1', b'1', NULL, '2021-01-14 15:25:59', NULL);
 ...
 CREATE TABLE `poetry` (
            `id` int  auto_increment PRIMARY KEY COMMENT '诗词ID',
            ...
            type varchar(20) COMMENT '诗词类型',
            `date` varchar(10) COMMENT '年代',
 ...
 CREATE TABLE `author` (
     ...
     experience text COMMENT '人生经历',
     photo varchar(50) COMMENT '照片',
     desty varchar(10) COMMENT '所属朝代',
     start_year varchar(10),
     end_year varchar(10),
     zi varchar(10) COMMENT '字',
